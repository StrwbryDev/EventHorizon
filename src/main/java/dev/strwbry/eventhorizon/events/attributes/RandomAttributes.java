...
/**
 * This event assigns a random set of attribute modifiers to all players.
 * Each time the event is executed, a new random set of attributes and values will be generated.
 */
public class RandomAttributes extends BaseAttribute {
    ...
    public RandomAttributes() {
        super(EventClassification.NEUTRAL, "randomAttributes");
    }

    /** This method executes the RandomAttributes event. */
    @Override
    public void execute() {
    ...
    /** This method terminates the RandomAttributes event. */
    @Override
